    ...
    >
      ...
      <div className="leave-balance-item">
        <div className="leave-label">
          ...
          <span className="leave-badge leave-badge-casual">{balances?.casual || 0} Days</span>
        </div>
        <div className="leave-bar-track">
      ...
      <div className="leave-balance-item">
        <div className="leave-label">
          ...
          <span className="leave-badge leave-badge-earned">{balances?.earned || 0} Days</span>
        </div>
        <div className="leave-bar-track">
...
export default React.memo(LeaveBalanceCard);
